...
/**
 * Explains the reasons why the template GTs are less restrictive than the template CCs.
 * The result is a mapping. For each less restrictive GT, the operation
 * associate a set of elements collides with it on the template CCs.
 * @author Carlos
 *
 */
public interface ExplainLessRestrictiveTemplateTermsOperation extends Operation {
	...
	/**
	 * Returns the mapping between Less Restrictive template GTs
	 * and template CCs
