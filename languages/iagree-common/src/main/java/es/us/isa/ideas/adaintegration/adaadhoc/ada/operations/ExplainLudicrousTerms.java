...
/**
 * This operation explains the dead terms of an 
 * agreement documents, mapping each dead term
 * detected with the elements cause it.
 * Previously, it is necessary to set
 * the dead terms of document, calculated by
 * DeadTermsOperation.
 *
 */
public interface ExplainLudicrousTerms extends Operation {
	...
	/**
	 * Returns the explaining of ludicrous terms. For each dead term
	 * previously set, it returns a set of elements that causes 
	 * the term is ludicrous.
	 * 
	 * A term is considered as ludicrous when its qualifying condition 
	 * is hold but the service level objective
     * is contradictory with other terms.
     * 
