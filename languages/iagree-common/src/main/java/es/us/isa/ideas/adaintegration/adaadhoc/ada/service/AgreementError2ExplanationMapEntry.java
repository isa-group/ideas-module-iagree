...
public class AgreementError2ExplanationMapEntry  implements java.io.Serializable {
    private es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.AgreementError key;

    private es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.Explanation value;

    public AgreementError2ExplanationMapEntry() {
    }

    public AgreementError2ExplanationMapEntry(
           es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.AgreementError key,
           es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.Explanation value) {
           this.key = key;
           this.value = value;
    }
     ...
     * @return key
     */
    public es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.AgreementError getKey() {
        return key;
    }
     ...
     * @param key
     */
    public void setKey(es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.AgreementError key) {
        this.key = key;
    }
     ...
     * @return value
     */
    public es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.Explanation getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(es.us.isa.ideas.adaintegration.adaadhoc.ada.errors.Explanation value) {
        this.value = value;
    }
