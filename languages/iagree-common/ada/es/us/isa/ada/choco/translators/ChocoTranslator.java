...
import es.us.isa.ada.wsag10.Preference;
	...
	protected void mapProperties(Iterator<Term> it) {
		...
		while (it.hasNext()) { // catching vars and metrics, and initializing
			...
			if (term instanceof ServiceProperties) {
				...
				Set<es.us.isa.ada.wsag10.Variable> variables = sp.getVariableSet();
				Iterator<es.us.isa.ada.wsag10.Variable> it3 = variables.iterator();
