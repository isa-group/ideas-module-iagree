...
/**
 * Explains the reasons why the offer is more restrictive than the template
 * The result is a mapping. For each more restrictive element on the offer, the operation
...
public interface ExplainMoreRestrictiveOfferOperation extends Operation {
	...
	/**
	 * Returns the mapping between More Restrictive offer elements
