...
var AbapHighlightRules = function() {
    ...
    var def = "\\b(Responder|ServiceProvider|ExpirationTime|MonitorableProperties|Service|description|Global|GuaranteeTerms|Constraints|Service|Metrics)\\b";
    ...
    var atom = "\\b(version|belongs|for|of|if|as|measuredBy|relatedTo|availableAt|definedAt|monitoredAt|valueOf|is|IMPLIES|EQUAL)\\b";
    var atom2 = "(\\b(except|from|during|on|AND|OR|NOT)\\b)";
    var condition = "\\b(all|exactly|one|or|more)\\b";
    var roles = "\\b(Initiator|Provider|Consumer)\\b";
    var attribute = "\\b(onlyIf|upon|[\w\$_]:)\\b";
    var type = "\\b(integer|string|enum|set|boolean|float)\\b";
    var interval = "\\b(yearly|monthly|weekly|daily|hourly|minutely)\\b";
